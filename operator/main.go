...
import (
	...
	"github.com/yimgzz/dummy-cd/operator/controllers"
...
func init() {
	...
	utilruntime.Must(dummycdv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	dummyClient, err := dummycd.NewServerClient(dummycdServerAddr)

	if (err != nil) || (dummyClient == nil) {
